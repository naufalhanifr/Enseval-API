...
<div class="col">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title text-primary ">Tambah stock</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('warehouse.stock.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row form-group">
                    ...
                    <div class=" col-5 col-md-9">
                        <input type="number" name="quantity" id="quantity" cols="30" rows="5" class="form-control"></input>
                    </div>
                </div>
